# Generated by Django 4.0.6 on 2022-07-06 03:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional', models.ManyToManyField(blank=True, related_name='additional_from', to='app_drf.food', verbose_name='Дополнительные товары')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='food', to='app_drf.foodcategory', verbose_name='Раздел меню')),
            ],
            options={
                'verbose_name': 'Еда',
